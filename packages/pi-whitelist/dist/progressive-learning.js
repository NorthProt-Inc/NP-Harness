 ...
 */
export function createPrefixTracker(threshold = 3) {
    return {
 ...
 */
export function recordAllowOnce(tracker, toolName, ruleContent) {
    if (!ruleContent)
        return null;
 ...
 */
function extractPrefixes(toolName, ruleContent) {
    const prefixes = [];
...
//# sourceMappingURL=progressive-learning.js.map