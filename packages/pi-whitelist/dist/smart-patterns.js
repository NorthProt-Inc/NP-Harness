 ...
 */
export function suggestBashPatterns(command) {
    const patterns = [];
 ...
 */
export function suggestFilePatterns(filePath) {
    const patterns = [];
    // Exact file
    patterns.push({
        pattern: filePath,
 ...
 */
export function generateSmartDefault(toolName, ruleContent) {
    if (!ruleContent)
        return undefined;
...
//# sourceMappingURL=smart-patterns.js.map