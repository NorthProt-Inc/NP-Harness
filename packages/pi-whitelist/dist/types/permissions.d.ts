...
export declare const EXTERNAL_PERMISSION_MODES: readonly ["acceptEdits", "auto", "bypassPermissions", "default", "dontAsk", "plan"];
export declare const MODE_CYCLE: readonly ["default", "auto", "plan", "bypassPermissions"];
export declare const PERMISSION_MODE_ALIASES: {
    readonly default: "default";
    readonly auto: "auto";
    readonly plan: "plan";
    readonly bypass: "bypassPermissions";
