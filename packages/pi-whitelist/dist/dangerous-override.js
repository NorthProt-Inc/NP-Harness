 ...
 */
export function checkDangerousOverride(toolName, ruleContent) {
    for (const pattern of DANGEROUS_PATTERNS) {
        if (pattern.toolName.toLowerCase() !== toolName.toLowerCase())
            continue;
...
//# sourceMappingURL=dangerous-override.js.map